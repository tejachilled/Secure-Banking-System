...
public class TransactionController {
    ...
    public ModelAndView approveTransactionsRE(@ModelAttribute("transactionIdList") TransactionList TidList, @RequestParam String toDo) {
    	ModelAndView model = new ModelAndView();
    	model.setViewName("authorizeTransactions");
    	String status ="";
    	try {
    	if( toDo.equalsIgnoreCase("Approve") ){
    	     status ="A";
    	     transactionService.approveTransactions(TidList.getTidList(), SecurityContextHolder.getContext().getAuthentication().getName(), status);
    ...
    public ModelAndView approveTransactionsSM(@ModelAttribute("transactionIdList") TransactionList TidList, @RequestParam String toDo) {
    	ModelAndView model = new ModelAndView();
    	model.setViewName("authorizeTransactions");
    	String status ="";
    	try {

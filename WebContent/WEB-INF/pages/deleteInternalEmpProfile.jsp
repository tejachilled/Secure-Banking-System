...
<jsp:include page="internalHome.jsp"></jsp:include>
    <form:form class="form-horizontal" commandName="accessInfo" method="post" action="/RichirichBank/DeleteInternalEmpProfile">
    <fieldset>
   ...
   <h4>Are you sure you want to delete this employee record?</h4>
	<form:form commandName="accessInfo" action="/RichirichBank/DeleteInternalEmpProfile" method="post">

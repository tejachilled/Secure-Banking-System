			...
			<ul class="nav navbar-nav">
				...
				<sec:authorize access="hasRole('ROLE_SA')"><li class="dropdown"><a href="#" class="dropdown-toggle"
					...
					<ul class="dropdown-menu">
						<sec:authorize access="hasRole('ROLE_SA')"><li><a href="/RichirichBank/register">Add a new account</a></li></sec:authorize>
						<sec:authorize access="hasRole('ROLE_SA')"><li><a href="/RichirichBank/ViewEmpProfile">View Emp</a></li></sec:authorize>
                        <sec:authorize access="hasRole('ROLE_SA')"><li><a href="/RichirichBank/EditEmpProfile">Edit Emp</a></li></sec:authorize>
